                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        transactionTextfield(Theme.of(context).primaryColor, descFocusNode, descController,
                            'Description', '(Optional) Enter description', false),
                        transactionTextfield(Theme.of(context).primaryColor, amountFocusNode, amountController,
                            'Amount', 'Enter the amount (eg. 0.00)', true),
                        Row(
