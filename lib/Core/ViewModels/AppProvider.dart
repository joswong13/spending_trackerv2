...
class AppProvider extends BaseProvider with CategoryDBProvider {
  ...
  Future<int> updateUserCategory(
    ...
    int resp = await super.updateUserCategory(id, name, colorOne, colorTwo, icon, position);

    if (resp == 1) {
      await refreshUserCategoryList();
    }
  ...
  Future<int> deleteCategory(int id) async {
    int resp = await super.deleteCategory(id);
